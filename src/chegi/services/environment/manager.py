...
class EnvManager:
    ...
    def generate_gitignore(self, env_names: List[str], target_dir: str = ".") -> Path:
        ...
        """
        if not env_names:
            raise NoEnvironmentsProvidedError("No environments provided for gitignore generation.")
        ...
        for env_name in env_names:
            ...
            for line in template_lines:
                ...
                if not stripped_line or stripped_line.startswith("#") or stripped_line not in seen_rules:
