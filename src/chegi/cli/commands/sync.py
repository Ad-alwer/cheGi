...
def sync() -> None:
    ...
    try:
        ...
        if not is_clean:
            console.print("[yellow]Workspace is not clean. Stashing changes...[/yellow]")
        ...
        try:
            ...
            if not is_clean:
                ...
                try:
                    ...
                    console.print(f"[bold red]Warning: Could not automatically pop stash. Details: {stash_err}[/bold red]")
